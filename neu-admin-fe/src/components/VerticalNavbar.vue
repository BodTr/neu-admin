        ...
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'moumoa-manage-page', params: {id: programId} }">
              ...
              <span class="nav-link-title">Quản lí MOU.MOA</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'htqt-manage-page', params: {id: programId} }">
              ...
              <span class="nav-link-title">Quản lí các dự án HTQT</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" :to="{ name: 'ex-f-student-manage-page', params: {id: programId} }">
              ...
              <span class="nav-link-title">Quản lí sinh viên nước ngoài đến trao đổi</span>
            </router-link>
          </li>
          <li class="nav-item">
