...
router.post('/api/create-moumoa', initMoumoaDocMiddleware, upload.single("attachedDoc"), emptyFileMoumoaInputValidation, emptyMoumoaInputsValidation, typeMoumoaInputsValidation, async (req, res, next) => {
    try {
...
router.put('/api/edit-moumoa/:id', upload.single("attachedDoc1"), emptyMoumoaInputsValidation, typeMoumoaInputsValidation, async(req, res) => {
    try {
        const { id } = req.params
